...
and connect to them over SSH as root. For this purpose you must have a SSH key file available in ``~/.ssh`` (no matter the encryption). Using the standard Grid'5000
