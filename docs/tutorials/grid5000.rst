...
::
    ...
    Finished 1 tasks (Granting root acces on the nodes (sudo-g5k))
    ─────────────────────────────────────────────────────────────────────────────────────────────────────────
...
Multisites deployment
=====================

There's no global scheduler on Grid'5000. So multisites reservation involves
